...
namespace onix.api.Migrations
{
    ...
    [Migration("20260923041349_InventoryDoc_StatusDate_Project_001")]
    partial class InventoryDoc_StatusDate_Project_001
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MAgent", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSeenErrorDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_error_seen_date");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MAgentEvent", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MCaseManagement", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrgId", "Ref")
                        .IsUnique();

                    b.ToTable("CaseManagements");
                });

            modelBuilder.Entity("Its.Onix.Api.Models.MCaseManagementComment", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("CaseManagementComments");
                });

            modelBuilder.Entity("Its.Onix.Api.Models.MConfiguration", b =>
                {
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MDocumentNumberConfig", b =>
                {
                    ...
                    b.Property<string>("LastDocumentNumber")
                        .HasColumnType("text")
                        .HasColumnName("last_document_number");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MFinancialDoc", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExpenseItemsDefinition")
                        .HasColumnType("text")
                        .HasColumnName("expense_items_def");
                    ...
                    b.Property<string>("RevenueItemsDefinition")
                        .HasColumnType("text")
                        .HasColumnName("revenue_items_def");

                    b.Property<string>("SharingItemsDefinition")
                        .HasColumnType("text")
                        .HasColumnName("sharing_items_def");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MInventoryDoc", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MInventoryDocItem", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("inventory_document_item_id");
                    ...
                    b.Property<decimal?>("FromLocationCurrentAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_current_amount");

                    b.Property<decimal?>("FromLocationCurrentQuantity")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_current_quantity");

                    b.Property<decimal?>("FromLocationCurrentUnitPrice")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_current_unit_price");
                    ...
                    b.Property<decimal?>("FromLocationPreviousAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_previous_amount");

                    b.Property<decimal?>("FromLocationPreviousQuantity")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_previous_quantity");

                    b.Property<decimal?>("FromLocationPreviousUnitPrice")
                        .HasColumnType("numeric")
                        .HasColumnName("from_location_previous_unit_price");
                    ...
                    b.Property<decimal?>("ToLocationCurrentAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_current_amount");

                    b.Property<decimal?>("ToLocationCurrentQuantity")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_current_quantity");

                    b.Property<decimal?>("ToLocationCurrentUnitPrice")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_current_unit_price");
                    ...
                    b.Property<decimal?>("ToLocationPreviousAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_previous_amount");

                    b.Property<decimal?>("ToLocationPreviousQuantity")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_previous_quantity");

                    b.Property<decimal?>("ToLocationPreviousUnitPrice")
                        .HasColumnType("numeric")
                        .HasColumnName("to_location_previous_unit_price");
                    ...
                    b.ToTable("InventoryDocItems");
                });

            modelBuilder.Entity("Its.Onix.Api.Models.MInventoryItem", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MInventoryLocation", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MIoc", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("oic_id");
                    ...
                    b.HasIndex("OrgId", "IocType", "IocValue")
                        .IsUnique();
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MJob", b =>
                {
                    ...
                    b.Property<string>("JobMessage2")
                        .HasColumnType("text")
                        .HasColumnName("job_message2");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MMerchant", b =>
                {
                    ...
                    b.Property<bool>("IncludeGlobalBankAccount")
                        .HasColumnType("boolean")
                        .HasColumnName("include_global_bank_account");
                    ...
                    b.Property<string>("PayoutNotMatchActionP2P")
                        .HasColumnType("text")
                        .HasColumnName("payout_not_match_action_p2p");
                    ...
                    b.Property<string>("WhitelistBankAccountNames")
                        .HasColumnType("text")
                        .HasColumnName("whitelist_bank_account_names");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MNotiChannel", b =>
                {
                    ...
                    b.Property<string>("EventsMatched")
                        .HasColumnType("text")
                        .HasColumnName("events_matched");
                    ...
                    b.Property<string>("TelegramWebhookUrl")
                        .HasColumnType("text")
                        .HasColumnName("telegram_webhook_url");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MOrganizationPolicy", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("org_policy_id");

                    b.Property<string>("ApiBlacklistIps")
                        .HasColumnType("text")
                        .HasColumnName("api_blacklist_ips");

                    b.Property<string>("ApiWhitelistIps")
                        .HasColumnType("text")
                        .HasColumnName("api_whitelist_ips");
                    ...
                    b.Property<string>("WebBlacklistIps")
                        .HasColumnType("text")
                        .HasColumnName("web_blacklist_ips");

                    b.Property<string>("WebWhitelistIps")
                        .HasColumnType("text")
                        .HasColumnName("web_whitelist_ips");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MPaymentRequest", b =>
                {
                    ...
                    b.Property<bool>("IsPayInBankAccountOverride")
                        .HasColumnType("boolean")
                    ...
                    b.Property<decimal?>("PayOutTotalAmountDecimalP2P")
                        .HasColumnType("numeric")
                        .HasColumnName("total_payout_amount_decimal_p2p");
                    ...
                    b.Property<string>("PayinAccountTypeOverride")
                        .HasColumnType("text")
                        .HasColumnName("payin_account_type_override");
                    ...
                    b.Property<string>("PayinBankAccountNameOverride")
                        .HasColumnType("text")
                        .HasColumnName("payin_bank_account_name_override");

                    b.Property<string>("PayinBankAccountNo")
                        .HasColumnType("text")
                        .HasColumnName("payin_bank_account_no");

                    b.Property<string>("PayinBankAccountNoOverride")
                        .HasColumnType("text")
                        .HasColumnName("payin_bank_account_no_override");
                    ...
                    b.Property<string>("PayinPromptPayIdOverride")
                        .HasColumnType("text")
                        .HasColumnName("payin_promptpay_id_override");
                    ...
                    b.Property<string>("PayoutFeePayer")
                        .HasColumnType("text")
                        .HasColumnName("payout_fee_payer");

                    b.Property<double?>("PayoutFeePct")
                        .HasColumnType("double precision")
                        .HasColumnName("payout_fee_pct");

                    b.Property<bool?>("PayoutIsWithdrawal")
                        .HasColumnType("boolean")
                        .HasColumnName("payout_is_withdrawal");
                    ...
                    b.Property<string>("QrCodeP2P")
                        .HasColumnType("text")
                        .HasColumnName("qr_code_p2p");
            ...
            modelBuilder.Entity("Its.Onix.Api.Models.MRiskPolicy", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AllowBlankPayerName")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_blank_payer_name");

                    b.Property<bool>("AllowMaliciousPayerName")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_malicious_payer_name");

                    b.Property<bool>("AllowSuspiciousPayerName")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_suspicious_payer_name");

                    b.Property<bool>("AllowUnknownPayerName")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_unknown_payer_name");
