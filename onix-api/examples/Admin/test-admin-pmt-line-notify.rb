...
orgId = ENV['API_ORG']
keyFile = ".token"
bankAccountId = 'a0ebc677-6aa3-4454-9e7e-ee1aa6361e4b' #'00c52e50-15cc-429d-9ec4-ab93afc99057'
...
param =  {
  PaymentAmount: 457.83, #ต้อง match กับ payment request ก่อนหน้าด้วย
  RemainAmount: 0.00,
  TxType: "PayIn",
  SourceBankCode: "KTB",
